...
module.exports.handlers.getPatientDemographics = function(messageObj, session, send, finished) {
  ...
  let inpatientInfo = {};
  inpatientInfo.admissionDate = this.db.symbolTable.getVar('PSJPAD');
  inpatientInfo.admissionDiagnosis = this.db.symbolTable.getVar('PSJPDX');
  inpatientInfo.dischargeDate = this.db.symbolTable.getVar('PSJPDD');
  inpatientInfo.transferDate = this.db.symbolTable.getVar('PSJPTD');
  inpatientInfo.roombed = this.db.symbolTable.getVar('PSJPRB');
