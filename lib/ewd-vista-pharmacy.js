...
module.exports.handlers.getPatientDemographics = function(messageObj, session, send, finished) {
  ...
  // Address information
  // TODO: Confidential and Foreign addresses not tested.
  let address = {};
  ...
  // per PSOORUT2, if mailStatusCode is empty, it's just regular mail
  if (!mailInfo.mailStatusCode) mailInfo.mailStatusText = 'REGULAR MAIL';
