...
var controller = function(controller, jQuery) {
    ...
    function adjustCellDimensions() {
        ...
        if (displayDetails) {
            ...
            $("#app .item, #review td").height($.browser.mozilla ? "3em" : "2.5em");
        } else {
            $("#app .item .detail").fadeOut();
            $("#app .item, #review td").height($.browser.mozilla ? "1.75em" : "1.25em");
        }
        $(".backdrop td").height($.browser.mozilla ? $("#app .item").outerHeight() : $("#app .item").height());
    }
